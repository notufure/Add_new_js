      ...
      <div class="modal-body">
        <form id="form_news">
          <div class="form-group">
            ...
            <input type="text" class="form-control hidden btn-edit" id="datetime" name="datetime" autocomplete="off" >
          </div>
		  <div class="form-group">
		  	<label for="datetime" class="control-label hidden btn-edit">Edit Date Time:</label>
				<input type="datetime-local" class="form-control " id="datetime" name="datetime" autocomplete="off" >
		  </div>
          <div class="form-group">
		...
		if(chk_news_id!=null){
			...
			dataList.getItem(chk_news_id).done(function(res){
				if(res != null && res.data.length > 0){
					...
					modal.find("#datetime").val(res.data[0].news_date);
